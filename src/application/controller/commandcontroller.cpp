...
CommandController::CommandController() : m_command_interface(nullptr), m_kakoune_session(nullptr)
{
}

void CommandController::init(domain::CommandInterface *command_interface, ClientManager *client_manager,
