...
void MultiStyledMenuView::handleMouseScroll(MultiStyledMenuState &state, int scroll_amount, const domain::Menu &menu)
{
    switch (menu.getStyle())
    {
    case domain::MenuStyle::INLINE:
...
float MultiStyledMenuView::x() const
{
    ...
    {
    case domain::MenuStyle::INLINE:
        return m_inline_menu->x();
    case domain::MenuStyle::PROMPT:
        return m_prompt_menu->x();
    case domain::MenuStyle::SEARCH:
        return m_search_menu->x();
    }
    return 0;
}
...
float MultiStyledMenuView::y() const
{
    ...
    {
    case domain::MenuStyle::INLINE:
        return m_inline_menu->y();
    case domain::MenuStyle::PROMPT:
        return m_prompt_menu->y();
    case domain::MenuStyle::SEARCH:
        return m_search_menu->y();
    }
    return 0;
}
...
float MultiStyledMenuView::width() const
{
    ...
    {
    case domain::MenuStyle::INLINE:
        return m_inline_menu->width();
    case domain::MenuStyle::PROMPT:
        return m_prompt_menu->width();
    case domain::MenuStyle::SEARCH:
        return m_search_menu->width();
    }
    return 0;
}
...
float MultiStyledMenuView::height() const
{
    ...
    {
    case domain::MenuStyle::INLINE:
        return m_inline_menu->height();
    case domain::MenuStyle::PROMPT:
        return m_prompt_menu->height();
    case domain::MenuStyle::SEARCH:
        return m_search_menu->height();
    }
    return 0;
}
