...
void PromptMenuView::init(domain::Renderer *renderer, KakouneContentView *kakoune_content_view)
{
    m_renderer = renderer;
...
void PromptMenuView::render(const RenderContext &render_context, MenuViewState &state, const domain::Menu &menu,
                            int cursor_column)
{
    ...
    m_renderer->renderRoundedRectWithShadow(getRGBAColor(render_context.ui_options.color_border, default_border_color),
                                            ...
                                            layout.current().height, domain::CornerRadius(CORNER_RADIUS),
                                            SHADOW_LENGTH);
...
std::optional<int> PromptMenuView::findItemAtPosition(float x, float y, const MenuViewState &state,
...
void PromptMenuView::ensureItemVisible(MenuViewState &state, int index)
{
