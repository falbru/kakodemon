...
void PromptMenuView::init(std::shared_ptr<opengl::Renderer> renderer, std::shared_ptr<KakouneContentView> kakoune_content_view) {
  m_renderer = renderer;
...
void PromptMenuView::renderScrolledContent(const KakouneClient &kakoune_client,
