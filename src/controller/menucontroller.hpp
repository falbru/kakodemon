...
public:
    ...
    void init(std::shared_ptr<KakouneClient> kakoune_client, std::shared_ptr<EditorController> editor_controller, std::shared_ptr<PromptMenuView> prompt_menu_view, std::shared_ptr<InlineMenuView> inline_menu_view);
