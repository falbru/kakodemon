...
Alignment::Alignment(HorizontalAlignment horizontal, VerticalAlignment vertical) : h(horizontal), v(vertical)
{
}
...
{
    return {HorizontalAlignment::Right, VerticalAlignment::Center};
}
