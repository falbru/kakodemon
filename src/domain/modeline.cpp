...
ModeLine::ModeLine(std::optional<StatusLine> status_line, Line mode_line, Face default_face)
    : m_status_line(status_line), m_mode_line(mode_line), m_default_face(default_face)
{
}
